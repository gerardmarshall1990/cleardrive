...
async function createDeal(req, res) {
  ...
  if (!sellerId || !plate || typeof salePrice !== 'number' || salePrice <= 0) {
    return res.status(400).json({ error: 'sellerId, plate, and a positive salePrice are required' });
  }
...
module.exports = { createDeal, getDeal, advanceStage, verifyFines, generateDocs, getDocs, completeDeal, updateDetails };
